...
from genomeAI.Data.download.NcbiDatasetCli import NCBIDownloader  # Ensure this module is properly installed
            ...
            with open(fna_file, "rt") as file:
                for record in SeqIO.parse(file, "fasta"):
                    sequence_info = {
                        ...
                        "sequence": str(record.seq[:100]) + "..."  # Display first 100 bases
                    }
