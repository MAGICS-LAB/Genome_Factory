...
def benchmark_model(model, benchmark, per_device_train_batch_size_dict, gradient_accumulation_steps_dict, download=False):
    ...
    if benchmark == "GUE":
        ...
        model_name_or_path = "./genome_ocean"
        train_script = "train.py"
        output_dir = "output_GUE/genome_ocean"
    ...
    if benchmark == "Promoter":
        ...
        model_name_or_path = "./genome_ocean"
        train_script = "train.py"
        output_dir = "output_Promoter/genome_ocean"
    ...
    if benchmark == "Genomic_Benchmarks":
        ...
        model_name_or_path = "./genome_ocean"
        train_script = "train.py"
        output_dir = "output_Genomic_Benchmarks/genome_ocean"
...
benchmark_model("genome_ocean", "Genomic_Benchmarks", per_device_train_batch_size_dict2,gradient_accumulation_steps_dict2 , download=False)