...
def main():
    ...
    parser.add_argument("command", choices=["train", "inference", "webui", "download","process","protein","process_promoter","process_emp","process_enhancer","sae_train","sae_regression"],
                        help="train or inference or webui or download or process or protein or process_promoter or process_emp or process_enhancer or sae_train or sae_regression")
    ...
    if args.command == "train":
        ...
        run_protein(config)
    elif args.command == "process_promoter":
        run_promoter(config)
    elif args.command == "process_emp":
        run_emp(config)
    elif args.command == "process_enhancer":
        run_enhancer(config)
