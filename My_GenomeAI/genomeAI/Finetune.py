...
def run_experiment(
    ...
    cmd_list = [
        ...
        "--use_8bit", str(use_8bit),
        "--use_4bit", str(use_4bit),
    ...
    # If your train.py supports --plot_loss, you could add:
    # cmd_list += ["--plot_loss", str(plot_loss)]
...
def finetune_model(
    ...
    if finetuning_type=="adapter":
        if classification=="True":
            train_script_path = os.path.join(os.path.dirname(__file__), "train_adapter.py")

        if regression=="True":
            train_script_path = os.path.join(os.path.dirname(__file__), "train_adapter_regression.py")
    else:
        if classification=="True":
            train_script_path = os.path.join(os.path.dirname(__file__), "train.py")

        if regression=="True":
            train_script_path = os.path.join(os.path.dirname(__file__), "train_regression.py")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_8bit", type=str, default="False")
    ...
    parser.add_argument("--plot_loss", type=str, default="False")
    ...
    finetune_model(
        ...
        plot_loss=(args.plot_loss.lower() == "true"),
