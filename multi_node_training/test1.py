...
#     rank = int(os.environ.get("LOCAL_RANK", "0"))
#     world_size = int(os.environ.get("WORLD_SIZE", "2"))
#     print(os.environ.get("RANK", "-1"), os.environ.get("LOCAL_RANK", "-1"))
...
#     )
#     for i in range(10):
#         input_ids = torch.randint(1000, (2, 128, 128)).cuda()
#         attention_mask = torch.ones_like(input_ids).cuda()
#         print("start")
#         output = fsdp_model(input_ids, attention_mask=attention_mask)
#     import time
#     print("start")
#     time.sleep(10)
