...
#SBATCH -A m4713_g             # allocation
#SBATCH -t 00:20:00          # time
#SBATCH -N 8                 # nodes
...
export CACHE_DIR=/pscratch/sd/z/zhwang/hf_cache
...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
    ...
    --config_name ./model/model_mistral_15B \
    --tokenizer_name /pscratch/sd/z/zhihanz/bpe_metagenomics_4096 \
    --model_name_or_path /pscratch/sd/z/zhihanz/models/mistral_15B \
    ...
    --cache_dir $CACHE_DIR \
    --output_dir /pscratch/sd/z/zhihanz/models/mistral_15B_1024'
