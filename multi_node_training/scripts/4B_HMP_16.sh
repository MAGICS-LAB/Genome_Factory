...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
    ...
    --prepared_dataset /pscratch/sd/z/zhihanz/data/metegenomics/prepared/hmp_meta_min500_max50000/prepared_1024 \
    ...
    --cache_dir $CACHE_DIR \
    --output_dir /pscratch/sd/z/zhihanz/models/mistral_4B_hmp_frommeta55k'
