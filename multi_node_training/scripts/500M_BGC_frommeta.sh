...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
    ...
    --model_name_or_path /pscratch/sd/z/zhihanz/models/mistral_500M_1024_4M/model_50k \
    ...
    --cache_dir $CACHE_DIR \
    --output_dir /pscratch/sd/z/zhihanz/models/BGC/metagenomics_mistral_500M_1024'
