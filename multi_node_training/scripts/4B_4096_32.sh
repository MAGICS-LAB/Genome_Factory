...
#SBATCH -N 32                 # nodes
#SBATCH -G 128                 # gpus in each node
...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
    ...
    --model_name_or_path /pscratch/sd/z/zhihanz/models/mistral_4B_1024_new/model_55k \
    --prepared_dataset /pscratch/sd/z/zhihanz/data/metegenomics/prepared/hmp_meta_min500_max20000/prepared_4096 \
    ...
    --cache_dir $CACHE_DIR \
    --output_dir /pscratch/sd/z/zhihanz/models/mistral_4B_4096from55k_32'
