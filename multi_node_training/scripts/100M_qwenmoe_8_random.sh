...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
    ...
    --model_name_or_path /pscratch/sd/z/zhihanz/models/qwenmoe_8_100M_random \
    ...
    --cache_dir $CACHE_DIR \
    --output_dir /pscratch/sd/z/zhihanz/models/MOE/qwenmoe_8_100M_random'
