...
srun --jobid $SLURM_JOBID bash -c 'python -m torch.distributed.run \
    ...
    --model_name_or_path /pscratch/sd/z/zhihanz/models/BGC/metagenomics_mistral_4B_1024/model_meta55k_bgc15k \
    --prepared_dataset /pscratch/sd/z/zhihanz/data/BGC/prepared/prepared_10240 \
    ...
    --cache_dir $CACHE_DIR \
    --output_dir /pscratch/sd/z/zhihanz/models/BGC/metagenomics_mistral_4B_10240/'
