...
class MambaBlock(nn.Module):
    def __init__(
        ...
        self.mixer = mixer_cls(config.d_model)
...
class MambaMoELMHeadModel(nn.Module, GenerationMixin):
    ...
    def forward(self, input_ids, position_ids=None, inference_params=None, num_last_tokens=0):
        ...
        """
        hidden_states, all_router_logits = self.backbone(input_ids, inference_params=inference_params)
        if num_last_tokens > 0:
            hidden_states = hidden_states[:, -num_last_tokens:]
        lm_logits = self.lm_head(hidden_states)
        CausalLMOutput = namedtuple("CausalLMOutput", ["logits", "all_router_logits"])
        return CausalLMOutput(logits=lm_logits, all_router_logits=all_router_logits)
